...
use AwardWallet\Common\Itineraries\Transportation as OutputBus;
...
class Bus extends Itinerary
{
    ...
    protected function convertSegment(BusSegment $parsed, Extra $extra): OutputSegment
    {
        ...
        $r->transport->type = 'bus';
        $r->transport->vehicleClass = $parsed->getBusModel();
        $r->transport->name = $parsed->getBusType();
